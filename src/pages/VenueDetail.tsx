...
export function VenueDetail() {
  ...
  if (!venue) {
    return (
      <main className="flex flex-col items-center justify-center min-h-screen font-kulim text-primary gap-4">
        ...
        <Link to="/home" className="text-secondary underline">
          Back to home
        </Link>
      </main>
    );
  ...
  function handleBook(
    ...
    setBookingDetails({ checkIn, checkOut, nights, total });
    setBooked(true);
  }
      ...
      <main className="flex flex-col items-center justify-center min-h-screen font-kulim text-primary px-6 gap-6">
        ...
        <div className="border border-primary/20 rounded-2xl p-6 w-full max-w-sm flex flex-col gap-3 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span>
              {bookingDetails.checkIn.toLocaleDateString("en-GB", {
                day: "numeric",
                month: "short",
                year: "numeric",
              })}
          ...
          <div className="flex justify-between">
            ...
            <span>
              {bookingDetails.checkOut.toLocaleDateString("en-GB", {
                day: "numeric",
                month: "short",
                year: "numeric",
              })}
        ...
        <Link to="/home" className="text-secondary underline text-sm">
          Back to home
        </Link>
      </main>
    );
      ...
      <div className="relative bg-white rounded-t-3xl -mt-6 flex-1 px-6 pt-6 pb-16 max-w-2xl w-full mx-auto shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        ...
        <div className="flex items-start justify-between mb-1">
          ...
          <div className="flex items-center gap-1 text-secondary mt-1">
            ...
            <span className="font-normal text-sm">{venue.rating}</span>
          </div>
        </div>

        <p className="text-primary/70 text-sm mb-4">${venue.price}/night</p>
        ...
        <div>
          ...
          <BookingCalendar pricePerNight={venue.price} onBook={handleBook} />
        </div>
      </div>
    </main>
  );
